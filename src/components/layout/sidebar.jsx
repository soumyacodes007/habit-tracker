...
export function Sidebar() {
  ...
  return (
    <>
      ...
      <header className="lg:hidden sticky top-0 z-50 border-b border-orange-200 dark:border-stone-700 bg-gradient-to-r from-orange-50 to-amber-50 dark:from-stone-900 dark:to-stone-800 backdrop-blur supports-[backdrop-filter]:bg-background/60">
        <div className="flex items-center justify-between px-4 py-4">
          <Link href="/" className="flex items-center gap-2">
            <div className="flex h-10 w-10 items-center justify-center rounded-lg bg-gradient-to-br from-orange-500 to-amber-500 dark:from-orange-600 dark:to-red-700 text-white shadow-md">
          ...
          <div className="flex items-center gap-2">
            ...
            >
              {isOpen ? (
                <X className="h-6 w-6 text-orange-900 dark:text-stone-100" />
              ) : (
                <Menu className="h-6 w-6 text-orange-900 dark:text-stone-100" />
              )}
            </button>
          </div>
        </div>
      ...
      >
        {/* Sidebar Header */}
        <div className="flex items-center justify-between p-6 border-b border-orange-200 dark:border-stone-700">
          <Link href="/" className="flex items-center gap-3" onClick={() => setIsOpen(false)}>
            <div className="flex h-12 w-12 items-center justify-center rounded-xl bg-gradient-to-br from-orange-500 to-amber-500 dark:from-orange-600 dark:to-red-700 text-white shadow-lg flex-shrink-0">
          ...
          <button
            ...
            className="hidden lg:flex p-1 rounded-lg hover:bg-orange-100 dark:hover:bg-stone-700 transition-colors"
            aria-label="Toggle sidebar"
          >
            {isCollapsed ? (
              <ChevronRight className="h-5 w-5 text-orange-900 dark:text-stone-100" />
            ) : (
              <ChevronLeft className="h-5 w-5 text-orange-900 dark:text-stone-100" />
            )}
          </button>
        </div>
