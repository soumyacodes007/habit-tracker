  ...
  return (
    <>
      ...
      <div className="md:hidden">
        <header className="sticky top-0 z-50 w-full border-b border-orange-200 dark:border-stone-700 bg-orange-50 dark:bg-stone-900">
          <div className="flex h-14 items-center justify-between px-4">
            ...
            <div className="flex items-center gap-2">
              ...
              <button
                ...
                className="p-2 rounded-lg hover:bg-orange-100 dark:hover:bg-stone-700"
        ...
        {isOpen && (
          <>
            ...
            />
            <div className="fixed top-14 left-0 right-0 bottom-0 z-50 bg-orange-50 dark:bg-stone-900 border-r border-orange-200 dark:border-stone-700">
      ...
      <div className="hidden md:block">
        ...
        {/* Desktop Sidebar Spacer - Not needed with ml-64 */}
      </div>
    </>
  )
}